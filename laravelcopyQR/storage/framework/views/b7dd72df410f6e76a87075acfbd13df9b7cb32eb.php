            ...
            <div class="col-md-9 col-lg-8 mx-auto">
              <h3 class="login-heading mb-4">Register here!</h3>
               <form action="<?php echo e(url('post-registration')); ?>" method="POST" id="regForm">
                ...
                <a class="btn btn-lg btn-primary btn-block btn-login text-uppercase font-weight-bold mb-2"  href="<?php echo e(route('loginfunc')); ?>">Sign Up</a>
...
</html><?php /**PATH C:\xampp\htdocs\laravelcopyQR\resources\views/registration.blade.php ENDPATH**/ ?>